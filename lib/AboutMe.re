...
let column = (~nav=false, ~contents=?, css) =>
  Html.(
    Css.(
      <div
        className={css([
          Media(
            "min-width: " ++ px(Consts.Media.oneCol),
            [
              ("position", "sticky"),
    ...
    <body className={css(Styles.fullBody)} lang="en">
      <div className={css(Styles.columnWrapper)}>
        <div
          className={css([
            Media(
              "min-width: " ++ px(Shared.Consts.Media.oneCol),
              [("max-width", "400px")],
            ),
    ...
    <body className={css(Styles.fullBody)} lang="en">
      <div
        ...
        <div
          ...
          <main role="main">
            <article> {children |> String.concat("\n")} </article>
          </main>
